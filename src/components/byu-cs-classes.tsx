...
import { Aperture, BookOpen, Box, Clipboard, Briefcase, CheckCircle, Code, Cpu, Database, FileText, Film, GitBranch, Globe, Laptop, Layers, Layout, Mic, Puzzle, Server, Shield, Smartphone, Terminal, TrendingUp, Type, Users, Eye } from "lucide-react"
...
export function ByuCsClasses() {
  ...
  const filteredAndSortedClasses = classes
    ...
    .filter((cls) => semesterFilter === "All" || cls.when_taught.includes(semesterFilter))
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[600px] text-muted-foreground md:text-xl" style={{margin: "auto"}}>
